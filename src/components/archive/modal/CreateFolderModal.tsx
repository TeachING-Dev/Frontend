    ...
    >
      ...
      >
        ...
        <div className="mt-4 shrink-0">
          ...
          {errorMessage ? (
          <p className="mt-[5px] font-suit text-[14px] font-medium leading-[150%] tracking-[-0.42px] text-[#917DEC]">
            {errorMessage}
          </p>
          ) : (
              <div className="mt-[5px] flex items-center gap-1 font-suit text-[14px] font-medium leading-[150%] tracking-[-0.42px] text-[#42444C]">              <CircleAlert
                size={14}
                strokeWidth={1.8}
                className="shrink-0"
              />
