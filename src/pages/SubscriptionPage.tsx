          ...
          {plans.map((plan) => (
            <article key={plan.name} className="flex flex-col items-center">
              ...
              <button
                ...
                className={`relative flex h-72 w-full max-w-[500px] flex-col p-5 text-left transition ${
                  selectedPlan === plan.name
                    ? "rounded-[7px] border-2 border-[rgba(145,125,236,0)] bg-[#13151F] shadow-[0_0_50px_0_rgba(145,125,236,0.50)]"
                    : "rounded-[7px] border-2 border-[rgba(145,125,236,0)] bg-[#13151F]"
                }`}
              >
